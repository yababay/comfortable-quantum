...
Если вы видите хронологию развития квантовой механики как-то по-другому, можно склонировать этот репозиторий (или даже сделать форк) и поправить файл с данными `src/routes/quantum-history.json`. Он выглядит примерно так:
